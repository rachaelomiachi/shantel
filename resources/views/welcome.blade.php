            ...
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset ("assets/img/black&white.jpeg")}}')">
                ...
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end h-50%" style="background-image: url('{{ asset ("assets/img/proff.jpg")}}')">
                    <div class="img-bg-inner">
                ...
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end " style="background-image: url('{{ asset ("assets/img/happy.jpeg")}}')">
                    <div class="img-bg-inner">
                ...
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end h-5 w-70" style="background-image: url{{  asset('assets/img/2students.jpg')}};">
                    <div class="img-bg-inner">
          ...
          <div class="col-md-9 order-md-2">
            ...
            <div class="d-lg-flex post-entry-2">
              <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                <img src="assets/img/2students.jpg" alt="" class="img-fluid">
              </a>
              <div>
